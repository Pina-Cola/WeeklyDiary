...
\begin{description}
	...
	\begin{itemize}
		...
		\item Look into proto 3 syntax
		\item Getting overview over structure of melt
		\item Look into \texttt{local\_melt.py}
		\item Execute melt with filter without JIT to test the filters: \texttt{melt url{https://s3.eu-central-1.amazonaws.com/accurate-player-demo-assets/timecode/sintel-2048-timecode-stereo.mp4} -filter greyscale} for greyscale
