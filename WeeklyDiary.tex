...
%----------------------------------------------------------------------------
	...
	\begin{itemize}
			...
			\item[$\square$] Figuring out where/how to apply filter in melt:
			
			\begin{itemize}
				
				\item[$\square$] Look into \texttt{jit-webrtc/mlt/src/melt/jit.c} and alter \texttt{jit\_action} function
			...
			\item[$\square$] Round value for red to two decimal digits (?)
