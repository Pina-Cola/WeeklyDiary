...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{longtable}{@{\,}r <{\hskip 2pt} !{\foo} >{\raggedright\arraybackslash}p{12cm}}
			...
			Week 5 & Set up code on my computer and familiarizing with codebase and research on the topic, including finding literature, set up Git and \LaTeX \ for master thesis \\
