...
%----------------------------------------------------------------------------
\item[27.03.24, Wednesday]
\begin{itemize}
	\item[]
	
	\item Writing on thesis:
	\begin{itemize}
		\item[\done] Use $\sim$ before \texttt{ref} and \texttt{cite}
		\item[\done] Change title 
		\item[\done] Introduce and explain RGB
		\item[$\square$] RGB graphics
		\item[$\square$] Barrierefreiheit into motivation
		\item[$\square$] Less links in bibliography
	\end{itemize}
	...
	\item Deciding what to do and how:
