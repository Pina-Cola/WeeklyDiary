...
\begin{description}
	...
	\begin{itemize}
		...
		\item[$\square$] Seperate \LaTeX file for master thesis into the chapters (as single files)
		...
		\begin{itemize}
			\item[$\square$] Describing functionality of MLT framework in master thesis
			\item[$\square$] Effects of different colours
			\item[$\square$] Colour Correction and Colour Grading
		\end{itemize}
