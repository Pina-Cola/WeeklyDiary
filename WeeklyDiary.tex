...
%----------------------------------------------------------------------------
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item References: Use footnotes for the URLs (not in reference list):
		\end{itemize}
	\end{itemize}

% TODO:
% alle Ecken abrunden?
% Captions an Grafiken?
% short version of graphic descripion for list of figures (and tables)
