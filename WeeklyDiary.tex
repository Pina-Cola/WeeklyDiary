...
\begin{description}
	...
	\includegraphics[width=1.4cm]{codemill.png}
	\begin{itemize}
		\item Reading code in \texttt{melt.c} and other melt files to find out, where to attach a filter/plugin to a video and where the quality setting is changed
