...
\begin{itemize}
	\item[]
	\item Looking into the data path of the quality parameter in the code for better understanding:
	\begin{itemize}
		...
		\item[$\rightarrow$] class \texttt{JitService} extends class \texttt{Service} and has 
	\end{itemize}
\end{itemize}
